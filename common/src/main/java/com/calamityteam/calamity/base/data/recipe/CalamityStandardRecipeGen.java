...
public abstract class CalamityStandardRecipeGen extends CalamityRecipeProvider {
    ...
    protected CalamityStandardRecipeGen(DataGenerator pGenerator) {
        super(pGenerator);
    }
    ...
    public String getName() {
        return "Calamity's Standard Recipes";
    }
    ...
    class GeneratedRecipeBuilder {
        ...
        private ResourceLocation createSimpleLocation(String recipeType) {
            return Calamity.asResource(recipeType + "/" + getRegistryName().getPath() + suffix);
        }

        private ResourceLocation createLocation(String recipeType) {
            return Calamity.asResource(recipeType + "/" + path + "/" + getRegistryName().getPath() + suffix);
        }
