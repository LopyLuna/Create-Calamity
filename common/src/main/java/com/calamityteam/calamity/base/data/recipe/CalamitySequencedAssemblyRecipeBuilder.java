 ...
 */
public class CalamitySequencedAssemblyRecipeBuilder extends SequencedAssemblyRecipeBuilder {
    public CalamitySequencedAssemblyRecipeBuilder(ResourceLocation id) {
        super(id);
    }
     ...
     * @return this
     */
    public CalamitySequencedAssemblyRecipeBuilder conditionalMaterial(TrackMaterial trackMaterial) {
        String namespace = trackMaterial.id.getNamespace();
        if (!Calamity.MOD_ID.equals(namespace)) {
